    ...
    <d2-container class="page">
        <el-card shadow="never" class="d2-mb">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="工作居住地 : " prop="num" style="display:inline-block">
                        <el-input v-model.number="ruleForm.num" placeholder="请输入您的工作居住地" clearable="" value2="" value="" prefix-icon="el-icon-edit" style="width:300px;margin-right:30px;"></el-input> 
                    </el-form-item>
    ...
    return {
      ...
      zk_cli:false,
        ...
        rules: {
          ...
          num: [
            { required: true, message: '请输入工作居住地', trigger: 'blur' },
          ]
        }
    }
  },mounted(){
