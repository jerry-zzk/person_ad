<template>
  <d2-container>
    ...
    <div style="background:#fff;margin-top:-20px;border:5px solid #d5d8de;border-top:20px solid #d5d8de;">
      <p style="background:#aaa;opacity:0.2;height:30px;margin-bottom:-16px;line-height:30px;iwdth:100%;margin-top:0px;color:#333;">共搜索出 <b style="color:#000;"> {{resault}} </b> 条信息</p>
      <!-- 表格 -->
      <demo-page-header
        slot="header"
        @submit="handleSubmit"
