    ...
    <d2-container class="page">
        <el-card shadow="never" class="d2-mb">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="企业名称 : " prop="name" style="display:inline-block">
                        <el-input v-model="ruleForm.name"  placeholder="请输入您的企业名称" clearable="" value1="" prefix-icon="el-icon-edit" value="" style="width:300px;margin-right:30px;"></el-input>
                    </el-form-item>
...
export default {
  ...
  data () {
    return {
        ...
        rules: {
          name: [
            { required: true, message: '请输入核验企业名称', trigger: 'blur' },
