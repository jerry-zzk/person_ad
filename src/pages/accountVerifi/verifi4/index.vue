    ...
    <d2-container class="page">
        <el-card shadow="never" class="d2-mb">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="信用卡银行 : " prop="num" style="display:inline-block">
                        <el-input v-model.number="ruleForm.num" placeholder="请输入您的信用卡银行" clearable="" value2="" value="" prefix-icon="el-icon-edit" style="width:300px;margin-right:30px;"></el-input>
                    </el-form-item>
    ...
    hide:false,
       zk_cli:false,
        ...
        rules: {
          ...
          num: [
            { required: true, message: '请输入信用卡银行', trigger: 'blur' }
          ]
        }
    }
  }, mounted(){
