<template class="page">
    <d2-container class="page">
        <el-card shadow="never" class="d2-mb">
            <h3>个人职业/手机号对应关系核验</h3>
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="个人职业 : " prop="name" style="display:inline-block">
                        <el-input v-model="ruleForm.name"  placeholder="请输入您的职业" clearable="" value1="" prefix-icon="el-icon-edit" value="" style="width:300px;margin-right:30px;"></el-input>
                    </el-form-item>
  ...
  data () {
    ...
    hide:false,
      zk_cli:false,
        ...
        rules: {
          name: [
            { required: true, message: '请输入核验职业', trigger: 'blur' },
