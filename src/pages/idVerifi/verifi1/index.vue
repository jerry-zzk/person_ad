<template class="page">
    <d2-container class="page">
        <el-card shadow="never" class="d2-mb">
            <h3>身份证号码/手机号对应关系核验</h3>
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="手机号 : " prop="name" style="display:inline-block">
                    ...
                    <el-form-item label="身份证号码 : " prop="num" style="display:inline-block">
                        <el-input v-model.number="ruleForm.num" placeholder="请输入您的身份证号码" clearable="" value2="" value="" prefix-icon="el-icon-edit" style="width:300px;margin-right:30px;"></el-input>
                    </el-form-item>
    ...
    hide:false,
       zk_cli:false,
        ...
        rules: {
          ...
          num: [
            { required: true, message: '请输入核验身份证号码', trigger: 'blur' },
            { type: 'number', message: '身份证号码为数字值'}
          ]
        }
    }
  },
