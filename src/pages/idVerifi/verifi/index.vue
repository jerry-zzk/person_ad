        ...
        <el-card shadow="never" class="d2-mb">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="姓名 : " prop="name" style="display:inline-block">
                        <el-input v-model="ruleForm.name"  placeholder="请输入您的姓名" clearable="" value1="" prefix-icon="el-icon-edit" value="" style="width:300px;margin-right:30px;"></el-input>
                    </el-form-item>
                    <el-form-item label="手机号 : " prop="num" style="display:inline-block">
...
export default {
  ...
  data () {
    return {
        ...
        rules: {
          name: [
            { required: true, message: '请输入核验姓名', trigger: 'blur' },
