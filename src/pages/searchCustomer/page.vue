<template>
    <d2-container id="search_customer" class="page">
        <div class="sCustomer-head">
            <p class="sCustomer-p">
                <d2-icon-svg name="isearch"
                             style="position:relative;width:32px;height:32px;top:4px;margin-right:10px;"></d2-icon-svg>
                <span class="sCustomer-title">客户搜索</span>
            </p>
            <p class="sCustomer-p">
                <input v-model="searchVal" class="sCustomer-input">
                <el-button @click="searchTable" class="sCustomer-btn" slot="append">搜 索</el-button>
            </p>
        </div>
        <div class="sCustomer-body">
            ...
            <div id="sCustomer_table" class="sc_table">
                <el-row class="sc_table-thead" :gutter="1">
                    <el-col :span="3">
                        <div class="sc_table-thead-td first">姓名</div>
                    </el-col>
                    <el-col :span="1">
                        <div class="sc_table-thead-td">性别</div>
                    </el-col>
                    <el-col :span="1">
                        <div class="sc_table-thead-td">年龄</div>
                    </el-col>
                    <el-col :span="3">
                        <div class="sc_table-thead-td">手机号</div>
                    </el-col>
                    <el-col :span="4">
                        <div class="sc_table-thead-td">身份证号</div>
                    </el-col>
                    <el-col :span="1">
                        <div class="sc_table-thead-td">种类</div>
                    </el-col>
                    <el-col :span="2">
                        <div class="sc_table-thead-td">时间</div>
                    </el-col>
                    <el-col :span="5">
                        <div class="sc_table-thead-td">地址</div>
                    </el-col>
                    <el-col :span="2">
                        <div class="sc_table-thead-td">黑名单</div>
                    </el-col>
                    <el-col :span="2">
                        <div class="sc_table-thead-td last">评分</div>
                    </el-col>
                </el-row>
                <el-scrollbar style="height: calc(100vh - 430px);border: 1px solid #ccc;">
                    <el-row v-for="item in tableData" :key="item.index" class="sc_table-tr" :gutter="1">
                        <el-col class="sc_table-tr-td" :span="3">
                            <div class="itd itd-first">{{item.name}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="1">
                            <div class="itd">{{item.gender}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="1">
                            <div class="itd">{{item.age}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="3">
                            <div class="itd">{{item.cellphone}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="4">
                            <div class="itd">{{item.idcard}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="1">
                            <div class="itd">{{item.type}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="2">
                            <div class="itd">{{item.time}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="5">
                            <div class="itd" :title="item.address">{{item.address}}</div>
                        </el-col>
                        <el-col class="sc_table-tr-td" :span="2">
                            <div class="itd">
                                <button v-if="item.blackList" @click="openPeopleInfoPopup(item.id)" class="itd-bl-Btn">
                                    <d2-icon-svg name="iconsumerBlacklist"
                                                 style="width:16px;height:16px;fill:#fff;"></d2-icon-svg>
                                </button>
                                <span v-else>&nbsp;</span>
                            </div>
                        </el-col>
