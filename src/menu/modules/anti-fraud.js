...
*/
export default [
    { path: '/index', title: '首页', iconSvg: 'd2-crud' },
    { path: '/antiFraud/addCustomer', title: '新客户提交', iconSvg: 'add_people' },
    { path: '/antiFraud/examineCustomer', title: '审核管理', iconSvg: 'examine' },
    {
      title: '欺诈警告',
      iconSvg: 'fraudAlert',
      children: [
    ...
    { path: '/antiFraud/searchCustomer', title: '客户检索', iconSvg: 'search_people' },
    {  
      title: '客户黑名单', 
      iconSvg: 'blacklist',
      children: [
        { path: '/antiFraud/idCard', title: '身份证黑名单',iconSvg: 'idcard' },
        { path: '/antiFraud/phone', title: '手机号黑名单',iconSvg: 'phone_black' },
        { path: '/antiFraud/virtualAcount', title: '虚拟账号黑名单',iconSvg: 'virtualAcount' },
        { path: '/antiFraud/ip', title: 'IP地址黑名单',iconSvg: 'ip' }
      ]
    },
    { path: '/antiFraud/count', title: '统计报告', iconSvg: 'count' },
    { path: '/antiFraud/manage', title: '业务管理', iconSvg: 'manage' },
  ]
