  ...
  methods:{
    ...
    initChart4() {
      	...
      	this.chart4.setOption({
		    ...
		    series: [{
		        name:'高危消费行为',
		        data: [420, 432, 401, 334, 390, 510, 520],
		        type: 'line',
		        smooth: true,
		        areaStyle: {}
		    }]
		    ...
		    series : [
		        {
		            ...
		            data:[
		                {value:3351, name:'赌博'},
		                {value:3101, name:'奢侈品'},
		                {value:1234, name:'娱乐场所'},
		                {value:1325, name:'出入境跨境消费'},
		                {value:1148, name:'XXX'}
		            ],
		            itemStyle: {
		                emphasis: {
